...
class MockItemsClient extends ItemsClient {
  late List<Item> initialItems;

  MockItemsClient({List<Item>? items}) : super(authentication: MockAuthentication()) {
    logger.d('[MockClient]');
  ...
  Future<Map<String, List<Item>>> fetchStaticLists() async {
    return {'user': MockData.users, 'listValue': MockData.listValues};
  }
}
