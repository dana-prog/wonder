// this file is copied from flex_color_scheme package example
...
class _ColorCardState extends State<ColorCard> {
  ...
  Widget build(BuildContext context) {
    ...
    // final bool isPhone =
    //     mediaSize.width < App.phoneWidthBreakpoint || mediaSize.height < App.phoneHeightBreakpoint;
    // final double fontSize = isPhone ? 10 : 11;
    // final Size effectiveSize = widget.size ?? (isPhone ? const Size(74, 54) : const Size(86, 58));
    final double fontSize = 10;
    final Size effectiveSize = widget.size ?? (const Size(74, 54));
